...
let activeWorkout = null; // { workoutId, items: [{ workoutExerciseId, exercise, sets: [...] }] }
...
$("createTplBtn").addEventListener("click", async () => {
  ...
  const { error } = await supabase.from("workout_templates").insert({ user_id: userId, name, split_type });
...
$("startWorkoutBtn").addEventListener("click", async () => {
  ...
  // fetch template exercises in order
...
$("saveWorkoutBtn").addEventListener("click", async () => {
  ...
  // Insert sets for each workout_exercise
